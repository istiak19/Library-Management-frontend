        ...
        <div className="card bg-gray-100 shadow-md border border-blue-200 p-3">
            <div className="card-body">
                ...
                <div className="pt-3 flex gap-3 justify-center flex-wrap">
                    ...
                    <Link
                        to={`/books/${book?._id}`}
                        className="px-4 py-2 font-semibold rounded-md cursor-pointer text-white bg-blue-600 hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-300"
                    >
                        View
                    </Link>
